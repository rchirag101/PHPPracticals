  ...
  <body>
   <!-- Navigation
    ...
    <nav id="tf-menu" class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        ...
        <div class="navbar-header">
          <a class="navbar-brand" href="practical3.php">PHP</a>
        </div>
    ...
    <div id="tf-home" style="background-image:url(img/04.jpg);" class="text-center">
        <div class="overlay">
            <div class="content">
                <h1><strong><span class="color">Practical # 3 </span></strong></h1>
                <p class="lead">Write PHP Script to print <strong>Fibonacci series.</strong></p>

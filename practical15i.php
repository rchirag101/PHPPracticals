  ...
  <body>
   <!-- Navigation
    ...
    <div id="tf-home" style="background-image:url(img/04.jpg);" class="text-center">
        <div class="overlay">
            <div class="content">
                <h1><strong><span class="color">Practical # 15</span></strong></h1>                <p class="lead">Create <strong>Website Registration Form</strong> using text box, check box,radio button, select, submit button. And display user inserted value in <strong>new PHP page.</strong></p>
    ...
    <div id="tf-about">
        <div class="container">
            <div class="row ">
            	<div class="col-lg-12">
            <center><h2><u>User Registration</u></h2></center><br/><br/>
             <form action="practical15ii.php" method="post">
                   <table align="center" width="30%" style="padding:30px; font-size:18px;">
                    ...
                    <tr>
                        ...
                        <td><select name="branch" style="width:278px;">
                                    <option value="Admin" size="30">Admin</option>
                                    <option value="Client" size="30">Client</option>                     
                            </select>
                        </td>
                    </tr>
                    <tr><td>  </td></tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="hobby[]" value="Singing"> Singing</input>	<br/>
                            <input type="checkbox" name="hobby[]" value="Writing"> Writing</input>

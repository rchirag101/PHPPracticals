  ...
  <body>
   <!-- Navigation
    ...
    <div id="tf-home" style="background-image:url(img/04.jpg);" class="text-center">
        <div class="overlay">
            <div class="content">
                <h1><strong><span class="color">Practical # 1</span></strong></h1>
                <p class="lead">Write a PHP script to display <u><strong>Welcome message.</strong></u></p>
    ...
    <div id="tf-about">
        <div class="container">
            <div class="row">
					<?php
                        echo  "<h2><center><u>Output :</u></center></h2><br/>" ;
						echo  "<h3><center>Welcome Friends</center></h3>" ;
                    ?>
            </div>
        </div>
    </div>
